...
<head>
  ...
  <title>D'Corner Coffee | Menu</title>
      ...
      <div class="container tm-position-relative">
        ...
        <div class="row tm-welcome-content">
          ...
          <p class="gray-text tm-welcome-description" style="text-align:center;"><?php
            echo "D'Corner Coffee menyediakan beberapa pilihan minuman baik kopi maupun non-kopi.";
          ?></p>
          <a href="#main" class="tm-more-button tm-more-button-welcome">Check Our Menu</a>      
        </div>
            ...
            <div class="col-lg-3 col-md-3">
              <div class="tm-position-relative margin-bottom-30">              
                <nav class="tm-side-menu">
                  <ul>
                    <li><a href="menu.php" class="active" id="coffee">Coffee</a></li>
                    <li><a href="menu_noncoffee.php" id="non-coffee">non-coffee</a></li>
                  </ul>              
                </nav>    
                <img src="img/vertical-menu-button.png" alt="Menu bg" class="tm-side-menu-bg">
              </div>  
            </div>            
            <div class="tm-menu-product-content col-lg-9 col-md-9"> <!-- menu content -->
              <div class="tm-product">
                <img src="img/dc-kopi-susu.png" alt="Product">
                <div class="tm-product-text">
                  <h3 class="tm-product-title">DC Coffee</h3>
                </div>
                <div class="tm-product-price">
                  <a href="#" class="tm-product-price-link tm-handwriting-font"><span class="tm-product-price-currency"></span>18k</a>
                </div>
              </div>
              <div class="tm-product">
                <img src="img/coffee-latte.png" alt="Product">
                <div class="tm-product-text">
                  <h3 class="tm-product-title">Coffee Latte</h3>
                </div>
                <div class="tm-product-price">
                  <a href="#" class="tm-product-price-link tm-handwriting-font"><span class="tm-product-price-currency"></span>17k</a>
                </div>
              </div>
              <div class="tm-product">
                <img src="img/Cappucino.png" alt="Product">
                <div class="tm-product-text">
              ...
              <div class="tm-product">
                ...
                <div class="tm-product-price">
                  <a href="#" class="tm-product-price-link tm-handwriting-font"><span class="tm-product-price-currency"></span>15k</a>
                </div>
              </div>
              <div class="tm-product">
                <img src="img/flavour-latte.png" alt="Product">
                <div class="tm-product-text">
                  <h3 class="tm-product-title">Flavour Latte</h3>
                </div>
                <div class="tm-product-price">
                  <a href="#" class="tm-product-price-link tm-handwriting-font"><span class="tm-product-price-currency"></span>18k</a>
                </div>
              ...
              <div class="tm-product">
                <img src="img/kopi-susu-gula-aren.png" alt="Product">
                <div class="tm-product-text">
                  <h3 class="tm-product-title">Kopi Susu Gula Aren</h3>
                </div>
                <div class="tm-product-price">
                  <a href="#" class="tm-product-price-link tm-handwriting-font"><span class="tm-product-price-currency"></span>16k</a>
                </div>
              </div>
              <div class="tm-product">
                <img src="img/bitter-sweet.png" alt="Product">
                <div class="tm-product-text">
                  <h3 class="tm-product-title">Bitter Sweet</h3>
                </div>
                <div class="tm-product-price">
                  <a href="#" class="tm-product-price-link tm-handwriting-font"><span class="tm-product-price-currency"></span>17k</a>
                </div>
              ...
              <div class="tm-product">
                <img src="img/candy-land.png" alt="Product">
                <div class="tm-product-text">
                  <h3 class="tm-product-title">Candy Land</h3>
                </div>
                <div class="tm-product-price">
                  <a href="#" class="tm-product-price-link tm-handwriting-font"><span class="tm-product-price-currency"></span>17k</a>
                </div>
